...
SELECT
    ...
    CASE
        ...
        ELSE (
            ...
            END)
    END AS sens,
    ST_LineLocatePoint(t.geom, ST_ClosestPoint(t.geom, p.geometrie))::numeric(32) AS position_sur_troncon
FROM 
...
SELECT 
    ...
    CASE
        ...
        ELSE (
            ...
            END)
    END AS sens,
    ST_LineLocatePoint(troncon_geom, panneau_projete)::numeric(32) AS position_sur_troncon
FROM buffer_data
